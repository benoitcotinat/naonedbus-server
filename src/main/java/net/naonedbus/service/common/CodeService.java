 ...
 */
public interface CodeService<BEAN extends BeanObjectCode>
    extends GenericService<BEAN>
{
    /**
     * Méthode générique de récupération d'un objet d'un type {@link BeanObjectCode}, en fonction
     * de son code.
     * @param code Le code de l'objet.
     * @return L'objet recherché.
     */
    BEAN get(final String code);
}
