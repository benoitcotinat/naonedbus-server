...
/**
 * Test l'ajout du separator entre les infos de topo et le message.
 * @author Benoît
 * @version $Revision$ $Date$
 */
public class CommentaireTopoSeparatorDecoratorTest
{

    /**
     * Décorator à tester.
     */
    private CommentaireTopoSeparatorDecorator decorator;
    ...
    public void setUp()
    {
        this.decorator = new CommentaireTopoSeparatorDecorator();
    }
    ...
    public void testDecorateWithTopo()
    {
        ...
        Assert.assertTrue(commentaire.getMessage().startsWith(NaonedbusConstants.TOPO_SEPARATOR));
    }
    ...
    public void testDecorateWithoutTopo()
    {
        ...
        Assert
                .assertFalse(commentaire
                        .getMessage()
                        .startsWith(NaonedbusConstants.TOPO_SEPARATOR));
